...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    def _create_sliding_window_attention_mask(self, input_tensor: torch.Tensor, window_size: int) -> torch.Tensor:
        """
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.has_sliding_layers:
            attention_mask["sliding_attention"] = self._create_sliding_window_attention_mask(
