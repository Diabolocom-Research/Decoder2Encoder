...
class BiQwen3Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`BiQwen3Model`]. It is used to instantiate a
